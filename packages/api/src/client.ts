...
export const addDocumentationArticle = (articleData: Omit<DocumentationArticle, 'id' | 'createdAt' | 'updatedAt'>): Promise<DocumentationArticle> => apiClient.post(`/public/documentation`, articleData, false);
export const updateDocumentationArticle = (slug: string, articleData: Partial<DocumentationArticle>): Promise<DocumentationArticle> => apiClient.put(`/public/documentation/${slug}`, articleData, false);
export const deleteDocumentationArticle = (slug: string): Promise<void> => apiClient.delete(`/public/documentation/${slug}`, false);

export const fetchLegalDocument = (type: 'terms' | 'privacy'): Promise<LegalDocument> => apiClient.get(`/public/legal/${type}`, true);
export const updateLegalDocument = (type: 'terms' | 'privacy', data: { content: string }): Promise<LegalDocument> => apiClient.put(`/public/legal/${type}`, data, false);

export const fetchPricingTiers = (): Promise<PricingTier[]> => apiClient.get(`/public/pricing`, true);
export const addPricingTier = (tierData: Omit<PricingTier, 'id'>): Promise<PricingTier> => apiClient.post(`/public/pricing`, tierData, false);
export const updatePricingTier = (tierId: string, tierData: Partial<PricingTier>): Promise<PricingTier> => apiClient.put(`/public/pricing/${tierId}`, tierData, false);
export const deletePricingTier = (tierId: string): Promise<void> => apiClient.delete(`/public/pricing/${tierId}`, false);

export const fetchTestimonials = (): Promise<Testimonial[]> => apiClient.get(`/public/testimonials`, true);
export const addTestimonial = (testimonialData: Omit<Testimonial, 'id'>): Promise<Testimonial> => apiClient.post(`/public/testimonials`, testimonialData, false);
export const updateTestimonial = (id: string, testimonialData: Partial<Testimonial>): Promise<Testimonial> => apiClient.put(`/public/testimonials/${id}`, testimonialData, false);
export const deleteTestimonial = (id: string): Promise<void> => apiClient.delete(`/public/testimonials/${id}`, false);

export const fetchFaqs = (): Promise<FAQ[]> => apiClient.get(`/public/faqs`, true);
export const addFaq = (faqData: Omit<FAQ, 'id'>): Promise<FAQ> => apiClient.post(`/public/faqs`, faqData, false);
export const updateFaq = (id: string, faqData: Partial<FAQ>): Promise<FAQ> => apiClient.put(`/public/faqs/${id}`, faqData, false);
export const deleteFaq = (id: string): Promise<void> => apiClient.delete(`/public/faqs/${id}`, false);
